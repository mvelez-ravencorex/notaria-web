...
const plans: Plan[] = [
    {
        ...
        annualPrice: null,
        annualMonthly: null,
        description: 'Parfait pour essayer NotarIA et voir comment ça fonctionne.',
        minutes: '90',
        minutesNote: 'à vie (unique)',
        maxDuration: '10 min',
        retention: '7 días',
        aiUses: '6',
        aiUsesNote: 'à vie',
        features: [
            { name: 'Traduction en direct', value: 'Gratuit' },
            { name: 'Analyse de sentiment', value: false },
            { name: 'Exporter / Partager', value: 'Utilise pool IA' },
            { name: 'Dossiers', value: false },
            { name: 'Téléchargements audio', value: false },
        ],
    },
    {
        name: 'Pro',
        ...
        annualPrice: '$99.99',
        annualMonthly: '$8.33',
        description: 'Pour les professionnels qui ont besoin de plus d\'enregistrement et d\'IA.',
        minutes: '500',
        minutesNote: 'par mois',
        maxDuration: '30 min',
        retention: '14 días',
        aiUses: '6',
        aiUsesNote: 'par mois',
        features: [
            ...
            { name: 'Analyse de sentiment', value: false },
            { name: 'Exporter / Partager', value: 'Utilise pool IA' },
            { name: 'Dossiers', value: true },
            { name: 'Téléchargements audio', value: '3/mois' },
        ],
    },
    {
        name: 'Plus',
        ...
        annualPrice: '$149.99',
        annualMonthly: '$12.50',
        description: 'Pour les utilisateurs avancés avec une IA supérieure et des exportations illimitées.',
        minutes: '1,200',
        minutesNote: 'par mois',
        maxDuration: '60 min',
        retention: '30 días',
        ...
        features: [
            { name: 'Traduction en direct', value: 'Gratuit' },
            { name: 'Analyse de sentiment', value: 'Basique' },
            { name: 'Exporter / Partager', value: 'Illimité' },
            { name: 'Dossiers', value: true },
            { name: 'Téléchargements audio', value: 'Illimité' },
        ],
        highlighted: true,
    },
    {
        ...
        annualPrice: '$199.99',
        annualMonthly: '$16.67',
        description: 'Pour les équipes avec un volume élevé et des insights de sentiment complets.',
        minutes: '1,800',
        minutesNote: 'par mois',
        maxDuration: 'Illimité',
        retention: '60 días',
        aiUses: '50',
        aiUsesNote: 'par mois',
        features: [
            { name: 'Traduction en direct', value: 'Gratuit' },
            { name: 'Analyse de sentiment', value: 'Complet' },
            { name: 'Exporter / Partager', value: 'Illimité' },
            { name: 'Dossiers', value: true },
            { name: 'Téléchargements audio', value: 'Illimité' },
        ],
    },
    {
        ...
        annualPrice: '$299.99',
        annualMonthly: '$25.00',
        description: 'Capacité maximale pour les organisations et les grandes équipes.',
        minutes: '2,800',
        minutesNote: 'par mois',
        maxDuration: 'Illimité',
        retention: '90 días',
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="flex text-center justify-center items-center gap-4 flex-col mb-16">
                    ...
                    >
                        ...
                        <p className="text-lg leading-relaxed text-gray-600 max-w-2xl text-center">
                            Un pool d'IA pour toutes les fonctionnalités. Vous choisissez comment dépenser vos utilisations.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <button
                            ...
                            aria-label="Activer la facturation annuelle"
                        >
                            <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {plans.map((plan, index) => {
                        ...
                        const displayPeriod = plan.annualPrice ? (showAnnual ? '/ mois' : '/ mois') : '';
                                        ...
                                        <div className="mb-6">
                                            ...
                                            {showAnnual && (
                                                <p className="text-xs text-amber-600 mt-1">
                                                    {plan.annualPrice}/an — facturé annuellement
                                                </p>
                                            )}
                                        </div>
                                        ...
                                        <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">max par enregistrement</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">rétention audio</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    Les utilisations IA sont partagées entre Résumé, Tâches, Moments clés, AI Chat, Diarisation des intervenants et exportations (Starter/Pro). La Traduction en direct est toujours gratuite.
                </motion.p>
                ...
                >
                    ...
                    >
                        ...
                        Téléchargez et choisissez votre forfait
                    </a>
                </motion.div>
            </div>
        </section>
