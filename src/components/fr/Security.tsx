...
const features = [
    {
        ...
        description: 'La traduction propulsée par Apple Translation Framework s\'exécute à 100% localement. Fonctionne hors ligne après le téléchargement des modèles de langue — gratuite sur tous les forfaits.'
    },
    {
        icon: Lock,
        title: 'Clés API sécurisées',
        description: 'Toutes les clés API sont stockées dans Firebase Secret Manager et ne sont jamais exposées au client. Les Cloud Functions servent de proxy sécurisé.'
    },
    {
        icon: Fingerprint,
        title: 'Vérification App Attest',
        description: 'L\'intégrité de l\'appareil est vérifiée via Apple App Attest, garantissant que seuls les appareils authentiques peuvent accéder au service.'
    },
    {
        icon: Timer,
        title: 'Limitation de débit',
        description: '10 requêtes par minute par utilisateur par action, appliquées côté serveur via une limitation basée sur Firestore.'
    }
];
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            Vos réunions,
                            <br />
                            <span className="bg-gradient-to-r from-amber-700 via-yellow-500 to-amber-600 bg-clip-text text-transparent">vos données</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            NotarIA est conçue avec la sécurité à chaque niveau. L'audio reste sur votre appareil jusqu'à ce que vous choisissiez de le traiter, la traduction ne quitte jamais votre téléphone, et toute communication cloud est chiffrée et authentifiée.
                        </motion.p>
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="font-semibold text-gray-900">État de sécurité</div>
                                            <div className="text-green-600 text-sm">Tous les systèmes sécurisés</div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        { label: 'App Attest', status: 'Vérifié', color: 'text-green-600' },
                                        { label: 'Traduction', status: 'Sur l\'appareil', color: 'text-green-600' },
                                        { label: 'Clés API', status: 'Secret Manager', color: 'text-amber-600' },
                                        { label: 'Limitation de débit', status: '10 req/min', color: 'text-blue-600' },
