                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="rounded-3xl p-8 border border-white/10 shadow-2xl" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(32px)', WebkitBackdropFilter: 'blur(32px)' }}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-2xl border border-white/10" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
                                    <div className="text-xs text-white/60 mb-3 uppercase tracking-wider font-medium">Entrée audio</div>
                                ...
                                <div className="flex items-center justify-center py-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-medium text-amber-300">Traitement par l'IA...</span>
                                    </motion.div>
                                </div>
                                ...
                                <div className="p-4 bg-emerald-500/10 backdrop-blur-md rounded-2xl border border-emerald-500/20">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-xs text-emerald-400 uppercase tracking-wider font-medium">Résumé prêt</span>
                                    </div>
                                    <p className="text-white/80 text-sm leading-relaxed">
                                        L'équipe a convenu de prioriser le lancement mobile pour le Q4. Les tâches clés incluent la finalisation de la documentation API et la planification des tests utilisateurs.
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    {[
                                        { label: 'Tâches', value: '3' },
                                        { label: 'Intervenants', value: '4' },
                                        { label: 'Durée', value: '45m' }
                                    ].map((stat) => (
                    ...
                    <motion.div className="order-1 lg:order-2" style={{ transform: `translateY(${-rightCardY}px)` }}>
                        ...
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                        >
                            Pas seulement de la transcription
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">Une véritable compréhension</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            Notre IA ne se contente pas de convertir la voix en texte. Elle comprend le contexte, identifie les intervenants, extrait les tâches et génère des résumés qui capturent ce qui compte vraiment.
                        </motion.p>

                        {/* Features List */}
                        <div className="space-y-5">
                            {[
                                { icon: Zap, title: 'Traitement en temps réel', description: 'Voyez la transcription en direct' },
                                { icon: Globe, title: '6 langues prises en charge', description: 'Anglais, Espagnol, Portugais, Français, Allemand, Italien' },
                                { icon: Shield, title: 'Traduction sur l\'appareil', description: 'La traduction est 100% locale via Apple Framework — gratuite sur tous les forfaits' }
                            ].map((feature, i) => (
                                <motion.div
                                    key={i}
