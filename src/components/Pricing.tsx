...
const plans: Plan[] = [
    {
        ...
        annualPrice: null,
        annualMonthly: null,
        description: 'Perfect to try NotarIA and see how it works.',
        minutes: '90',
        minutesNote: 'lifetime (one-time)',
        maxDuration: '10 min',
        retention: '7 days',
        aiUses: '6',
        aiUsesNote: 'lifetime',
        features: [
            { name: 'Live Translation', value: 'Free' },
            { name: 'Sentiment Analysis', value: false },
            { name: 'Export / Share', value: 'Uses AI pool' },
            { name: 'Folders', value: false },
    ...
    },
    {
        ...
        annualPrice: '$99.99',
        annualMonthly: '$8.33',
        description: 'For professionals who need more recording and AI.',
        minutes: '500',
        minutesNote: 'per month',
        maxDuration: '30 min',
        retention: '14 days',
        aiUses: '6',
        aiUsesNote: 'per month',
        features: [
            { name: 'Live Translation', value: 'Free' },
            { name: 'Sentiment Analysis', value: false },
            { name: 'Export / Share', value: 'Uses AI pool' },
            { name: 'Folders', value: true },
            { name: 'Audio Downloads', value: '3/month' },
        ],
    },
    {
        name: 'Plus',
        ...
        annualPrice: '$149.99',
        annualMonthly: '$12.50',
        description: 'For power users with advanced AI and unlimited exports.',
        minutes: '1,200',
        minutesNote: 'per month',
        maxDuration: '60 min',
        retention: '30 days',
        ...
        features: [
            { name: 'Live Translation', value: 'Free' },
            { name: 'Sentiment Analysis', value: 'Basic' },
            { name: 'Export / Share', value: 'Unlimited' },
            { name: 'Folders', value: true },
            { name: 'Audio Downloads', value: 'Unlimited' },
        ],
        highlighted: true,
    },
    {
        ...
        annualPrice: '$199.99',
        annualMonthly: '$16.67',
        description: 'For teams with high volume and full sentiment insights.',
        minutes: '1,800',
        minutesNote: 'per month',
        ...
        features: [
            { name: 'Live Translation', value: 'Free' },
            { name: 'Sentiment Analysis', value: 'Complete' },
            { name: 'Export / Share', value: 'Unlimited' },
            { name: 'Folders', value: true },
            { name: 'Audio Downloads', value: 'Unlimited' },
        ],
    },
    {
        ...
        annualPrice: '$299.99',
        annualMonthly: '$25.00',
        description: 'Maximum capacity for organizations and large teams.',
        minutes: '2,800',
        minutesNote: 'per month',
        maxDuration: 'Unlimited',
        retention: '90 days',
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="flex text-center justify-center items-center gap-4 flex-col mb-16">
                    ...
                    >
                        ...
                        <p className="text-lg leading-relaxed text-gray-600 max-w-2xl text-center">
                            One AI pool for all features. You choose how to spend your uses.
                        </p>
                    </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {plans.map((plan, index) => {
                        ...
                        const displayPeriod = plan.annualPrice ? (showAnnual ? '/ month' : '/ month') : '';
                                        ...
                                        <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">max per recording</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">audio retention</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    AI uses are shared across Summary, Action Items, Key Moments, AI Chat, Speaker Diarization, and exports (Starter/Pro). Live Translation is always free.
                </motion.p>
