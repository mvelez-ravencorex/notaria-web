...
const stages = [
    {
        number: '01',
        title: 'Aufnehmen',
        description: 'Aufnahme mit einem Tippen und fortschrittliche Rauschunterdrückung für kristallklaren Sound, überall.',
        iconColor: 'purple',
    ...
    },
    {
        ...
        description: 'KI-Echtzeit-Transkription mit 99% Genauigkeit und automatischer Sprechererkennung.',
        iconColor: 'blue',
    ...
    },
    {
        number: '03',
        title: 'Handeln',
        description: 'Erhalten Sie KI-Zusammenfassungen, wichtige Entscheidungen und exportieren Sie Aufgaben direkt in Ihre bevorzugten Tools.',
        iconColor: 'green',
        ...
        <section className="relative py-24 px-6 lg:px-20 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a0a1a 0%, #1a0a2e 50%, #0a1a2a 100%)' }}>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        Drei einfache Schritte für mühelose Produktivität.
                    </motion.p>
                </div>
