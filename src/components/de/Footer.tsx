...
const footerLinks = {
    ...
    Support: [
        { label: 'Hilfecenter', href: '/support' },
        { label: 'Häufige Fragen', href: '/support#faq' },
    ],
    Rechtliches: [
            ...
            <div className="max-w-6xl mx-auto px-6 lg:px-20 py-16">
                <div className="grid grid-cols-2 md:grid-cols-6 gap-6 md:gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <p className="text-gray-500 text-sm mb-6 max-w-xs">
                            KI-Meeting-Transkription, Zusammenfassungen und Aufgaben. 100% Datenschutz auf dem Gerät.
                        </p>
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-gray-400 text-sm">
                        &copy; {currentYear} NotarIA. Alle Rechte vorbehalten.
                    </p>
