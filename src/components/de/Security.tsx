...
const features = [
    {
        icon: Globe,
        title: 'Übersetzung auf dem Gerät',
        description: 'Die von Apple Translation Framework unterstützte Übersetzung läuft zu 100% lokal. Funktioniert offline nach dem Herunterladen der Sprachmodelle — kostenlos in allen Plänen.'
    },
    {
        icon: Lock,
        title: 'Sichere API-Schlüssel',
        description: 'Alle API-Schlüssel werden in Firebase Secret Manager gespeichert und niemals dem Client offengelegt. Cloud Functions fungieren als sicherer Proxy.'
    },
    {
        icon: Fingerprint,
        title: 'App Attest Verifizierung',
        description: 'Die Geräteintegrität wird mit Apple App Attest verifiziert, um sicherzustellen, dass nur echte Geräte auf den Dienst zugreifen können.'
    },
    {
        icon: Timer,
        title: 'Ratenbegrenzung',
        description: '10 Anfragen pro Minute pro Benutzer pro Aktion, serverseitig durch Firestore-basierte Begrenzung durchgesetzt.'
    }
];
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            Ihre Meetings,
                            <br />
                            <span className="bg-gradient-to-r from-amber-700 via-yellow-500 to-amber-600 bg-clip-text text-transparent">Ihre Daten</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            NotarIA ist mit Sicherheit in jeder Schicht aufgebaut. Audio bleibt auf Ihrem Gerät, bis Sie es verarbeiten lassen, die Übersetzung verlässt nie Ihr Telefon, und die gesamte Cloud-Kommunikation ist verschlüsselt und authentifiziert.
                        </motion.p>
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="font-semibold text-gray-900">Sicherheitsstatus</div>
                                            <div className="text-green-600 text-sm">Alle Systeme sicher</div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        { label: 'App Attest', status: 'Verifiziert', color: 'text-green-600' },
                                        { label: 'Übersetzung', status: 'Auf dem Gerät', color: 'text-green-600' },
                                        { label: 'API-Schlüssel', status: 'Secret Manager', color: 'text-amber-600' },
                                        { label: 'Ratenlimit', status: '10 Anf/Min', color: 'text-blue-600' },
