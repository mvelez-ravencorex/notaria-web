...
const plans: Plan[] = [
    {
        ...
        annualPrice: null,
        annualMonthly: null,
        description: 'Perfekt, um NotarIA auszuprobieren und zu sehen, wie es funktioniert.',
        minutes: '90',
        minutesNote: 'einmalig (Lifetime)',
        maxDuration: '10 min',
        retention: '7 Tage',
        aiUses: '6',
        aiUsesNote: 'einmalig',
        features: [
            { name: 'Live-Übersetzung', value: 'Kostenlos' },
            { name: 'Stimmungsanalyse', value: false },
            { name: 'Exportieren / Teilen', value: 'Nutzt KI-Pool' },
            { name: 'Ordner', value: false },
            { name: 'Audio-Downloads', value: false },
        ],
    },
    {
        name: 'Pro',
        ...
        annualPrice: '$99.99',
        annualMonthly: '$8.33',
        description: 'Für Profis, die mehr Aufnahme und KI benötigen.',
        minutes: '500',
        minutesNote: 'pro Monat',
        maxDuration: '30 min',
        retention: '14 Tage',
        aiUses: '6',
        aiUsesNote: 'pro Monat',
        features: [
            { name: 'Live-Übersetzung', value: 'Kostenlos' },
            { name: 'Stimmungsanalyse', value: false },
            { name: 'Exportieren / Teilen', value: 'Nutzt KI-Pool' },
            { name: 'Ordner', value: true },
            { name: 'Audio-Downloads', value: '3/Monat' },
        ],
    },
    {
        name: 'Plus',
        ...
        annualPrice: '$149.99',
        annualMonthly: '$12.50',
        description: 'Für Power-User mit überlegener KI und unbegrenzten Exporten.',
        minutes: '1,200',
        minutesNote: 'pro Monat',
        maxDuration: '60 min',
        retention: '30 Tage',
        ...
        features: [
            { name: 'Live-Übersetzung', value: 'Kostenlos' },
            { name: 'Stimmungsanalyse', value: 'Basis' },
            { name: 'Exportieren / Teilen', value: 'Unbegrenzt' },
            { name: 'Ordner', value: true },
            { name: 'Audio-Downloads', value: 'Unbegrenzt' },
        ],
        highlighted: true,
    },
    {
        ...
        annualPrice: '$199.99',
        annualMonthly: '$16.67',
        description: 'Für Teams mit hohem Volumen und vollständigen Stimmungs-Insights.',
        minutes: '1,800',
        minutesNote: 'pro Monat',
        maxDuration: 'Unbegrenzt',
        retention: '60 Tage',
        aiUses: '50',
        aiUsesNote: 'pro Monat',
        features: [
            { name: 'Live-Übersetzung', value: 'Kostenlos' },
            { name: 'Stimmungsanalyse', value: 'Vollständig' },
            { name: 'Exportieren / Teilen', value: 'Unbegrenzt' },
            { name: 'Ordner', value: true },
            { name: 'Audio-Downloads', value: 'Unbegrenzt' },
        ],
    },
    {
        ...
        annualPrice: '$299.99',
        annualMonthly: '$25.00',
        description: 'Maximale Kapazität für Organisationen und große Teams.',
        minutes: '2,800',
        minutesNote: 'pro Monat',
        maxDuration: 'Unbegrenzt',
        retention: '90 Tage',
        ...
        <section className="w-full py-20 lg:py-32 bg-gray-50">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="flex text-center justify-center items-center gap-4 flex-col mb-16">
                    ...
                    >
                        ...
                        <p className="text-lg leading-relaxed text-gray-600 max-w-2xl text-center">
                            Ein KI-Pool für alle Funktionen. Sie entscheiden, wie Sie Ihre Nutzungen einsetzen.
                        </p>
                    </motion.div>
                                ...
                                >
                                    {plan.highlighted && (
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                                            <Badge className="bg-amber-600 text-white">Am beliebtesten</Badge>
                                        </div>
                                    )}
                                        ...
                                        <div className="mb-6">
                                            ...
                                            {showAnnual && (
                                                <p className="text-xs text-amber-600 mt-1">
                                                    {plan.annualPrice}/Jahr — jährlich abgerechnet
                                                </p>
                                            )}
                                        </div>
                                        ...
                                        <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">max. pro Aufnahme</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">Audio-Aufbewahrung</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    KI-Nutzungen werden geteilt zwischen Zusammenfassung, Aufgaben, Schlüsselmomente, AI Chat, Sprecherdiarisation und Exporten (Starter/Pro). Live-Übersetzung ist immer kostenlos.
                </motion.p>
