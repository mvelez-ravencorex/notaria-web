                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="rounded-3xl p-8 border border-white/10 shadow-2xl" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(32px)', WebkitBackdropFilter: 'blur(32px)' }}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-2xl border border-white/10" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
                                    <div className="text-xs text-white/60 mb-3 uppercase tracking-wider font-medium">Audioeingang</div>
                                ...
                                <div className="flex items-center justify-center py-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-medium text-amber-300">KI-Verarbeitung...</span>
                                    </motion.div>
                                </div>
                                ...
                                <div className="p-4 bg-emerald-500/10 backdrop-blur-md rounded-2xl border border-emerald-500/20">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-xs text-emerald-400 uppercase tracking-wider font-medium">Zusammenfassung fertig</span>
                                    </div>
                                    <p className="text-white/80 text-sm leading-relaxed">
                                        Das Team hat sich darauf geeinigt, den mobilen Launch für Q4 zu priorisieren. Die wichtigsten Aufgaben umfassen die Fertigstellung der API-Dokumentation und die Planung von Benutzertests.
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    {[
                                        ...
                                        { label: 'Sprecher', value: '4' },
                                        { label: 'Dauer', value: '45m' }
                                    ].map((stat) => (
                    ...
                    <motion.div className="order-1 lg:order-2" style={{ transform: `translateY(${-rightCardY}px)` }}>
                        ...
                        >
                            ...
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">Echtes Verständnis</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            Unsere KI wandelt nicht nur Sprache in Text um. Sie versteht den Kontext, erkennt Sprecher, extrahiert Aufgaben und erstellt Zusammenfassungen, die das Wesentliche erfassen.
                        </motion.p>

                        {/* Features List */}
                        <div className="space-y-5">
                            {[
                                { icon: Zap, title: 'Echtzeit-Verarbeitung', description: 'Sehen Sie die Transkription, während sie passiert' },
                                { icon: Globe, title: '6 unterstützte Sprachen', description: 'Englisch, Spanisch, Portugiesisch, Französisch, Deutsch, Italienisch' },
                                { icon: Shield, title: 'Übersetzung auf dem Gerät', description: 'Die Übersetzung ist 100% lokal über Apple Framework — kostenlos in allen Plänen' }
                            ].map((feature, i) => (
                                <motion.div
                                    key={i}
