                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-24">
                        ...
                        <div className="flex-1 text-center lg:text-left z-10">
                            ...
                            >
                                ...
                                Jetzt mit AI Chat für Ihre Meetings
                            </motion.div>
                            ...
                            >
                                Meeting-Intelligenz{' '}
                                <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-700 to-yellow-600">in Sekunden</span>
                            </motion.h1>
                            ...
                            >
                                Nehmen Sie auf, transkribieren und fassen Sie Ihre Meetings mit KI zusammen. Stimmungsanalyse, Aufgaben, Sprechererkennung und Live-Übersetzung — alles auf iPhone und iPad.
                            </motion.p>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="ml-2">2.000+ Nutzer</span>
                                </div>
                        ...
                        <div className="flex-1 relative flex justify-center items-center">
                            ...
                            <FloatingCard className="right-0 -translate-x-0 lg:right-auto lg:left-full lg:-ml-20 top-8 p-3 w-[170px] md:w-[185px] hidden md:block" delay={0.5} rotate={5}>
                                ...
                                <div className="space-y-2">
                                    <div className="bg-gray-100 rounded-lg px-2 py-1.5">
                                        <p className="text-gray-600 text-[10px]">Welche Aufgaben gab es?</p>
                                    </div>
                                    <div className="bg-amber-50 rounded-lg px-2 py-1.5">
                                        <p className="text-amber-700 text-[10px]">3 Aufgaben wurden zugewiesen...</p>
                                    </div>
                                </div>
                            </FloatingCard>
                            ...
                            <FloatingCard className="right-0 -translate-x-0 lg:right-auto lg:left-full lg:-ml-20 top-2/3 p-3 w-[175px] md:w-[190px] hidden md:block" delay={0.7} rotate={-3}>
                                ...
                                <div className="mb-2">
                                    <div className="flex items-center justify-between mb-1">
                                        <span className="text-[10px] text-gray-400">Gesamtstimmung</span>
                                        <span className="text-[10px] font-medium text-emerald-500">Positiv</span>
                                    </div>
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex items-center justify-between">
                                        <span className="text-[10px] text-gray-400">Sprecher A</span>
                                        <div className="flex items-center gap-1">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-[10px] text-gray-400">Sprecher B</span>
                                        <div className="flex items-center gap-1">
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-8 p-3 w-[170px]" delay={0.8} rotate={-6}>
                                <div className="bg-gray-50 rounded-xl p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-xs font-medium text-gray-800">Aufnahme</span>
                                    </div>
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-1/3 p-3 w-[175px]" delay={0.9} rotate={3}>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-gray-800 text-xs font-medium">Übersetzung</span>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <p className="text-gray-500 text-[11px]">"Hallo, willkommen..."</p>
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-2/3 p-3 w-[195px]" delay={1.0} rotate={4}>
                                ...
                                <p className="text-gray-600 text-[11px] mb-2">
                                    "Spart uns <span className="bg-amber-100 px-1 rounded text-amber-700">jede Woche Stunden</span>!"
                                </p>
