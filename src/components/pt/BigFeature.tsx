                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="rounded-3xl p-8 border border-white/10 shadow-2xl" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(32px)', WebkitBackdropFilter: 'blur(32px)' }}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-2xl border border-white/10" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
                                    <div className="text-xs text-white/60 mb-3 uppercase tracking-wider font-medium">Entrada de Áudio</div>
                                ...
                                <div className="flex items-center justify-center py-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-medium text-amber-300">Processando com IA...</span>
                                    </motion.div>
                                </div>
                                ...
                                <div className="p-4 bg-emerald-500/10 backdrop-blur-md rounded-2xl border border-emerald-500/20">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-xs text-emerald-400 uppercase tracking-wider font-medium">Resumo Pronto</span>
                                    </div>
                                    <p className="text-white/80 text-sm leading-relaxed">
                                        A equipe concordou em priorizar o lançamento mobile para Q4. As tarefas principais incluem finalizar a documentação da API e agendar testes de usuário.
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    {[
                                        { label: 'Tarefas', value: '3' },
                                        { label: 'Falantes', value: '4' },
                    ...
                    <motion.div className="order-1 lg:order-2" style={{ transform: `translateY(${-rightCardY}px)` }}>
                        ...
                        <motion.h2
                            ...
                            viewport={{ once: true }}
                        >
                            Não é só transcrição
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">Verdadeira compreensão</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            Nossa IA não apenas converte voz em texto. Ela entende o contexto, identifica falantes, extrai tarefas e gera resumos que capturam o que realmente importa.
                        </motion.p>

                        {/* Features List */}
                        <div className="space-y-5">
                            {[
                                { icon: Zap, title: 'Processamento em tempo real', description: 'Veja a transcrição enquanto acontece' },
                                { icon: Globe, title: '6 idiomas suportados', description: 'Inglês, Espanhol, Português, Francês, Alemão, Italiano' },
                                { icon: Shield, title: 'Tradução no dispositivo', description: 'A tradução é 100% local via Apple Framework — grátis em todos os planos' }
                            ].map((feature, i) => (
                                <motion.div
                                    key={i}
