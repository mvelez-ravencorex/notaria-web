...
const stages = [
    {
        number: '01',
        title: 'Grave',
        description: 'Gravação com um toque e cancelamento de ruído avançado para áudio cristalino, em qualquer lugar.',
        iconColor: 'purple',
    ...
    },
    {
        number: '02',
        title: 'Transcreva',
        description: 'Transcrição em tempo real com IA com 99% de precisão e identificação automática de falantes.',
        iconColor: 'blue',
    ...
    },
    {
        number: '03',
        title: 'Ação',
        description: 'Receba resumos de IA, decisões-chave e exporte tarefas diretamente para suas ferramentas favoritas.',
        iconColor: 'green',
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Seu Caminho para Reuniões Claras
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        Três passos simples para uma produtividade sem esforço.
                    </motion.p>
                </div>
