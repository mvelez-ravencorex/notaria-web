...
const plans: Plan[] = [
    {
        ...
        annualPrice: null,
        annualMonthly: null,
        description: 'Perfeito para experimentar NotarIA e ver como funciona.',
        minutes: '90',
        minutesNote: 'vitalício (único)',
        maxDuration: '10 min',
        retention: '7 días',
        aiUses: '6',
        aiUsesNote: 'vitalício',
        features: [
            { name: 'Tradução ao Vivo', value: 'Grátis' },
            { name: 'Análise de Sentimento', value: false },
            { name: 'Exportar / Compartilhar', value: 'Usa pool IA' },
            { name: 'Pastas', value: false },
            { name: 'Downloads de Áudio', value: false },
        ],
    },
    {
        name: 'Pro',
        ...
        annualPrice: '$99.99',
        annualMonthly: '$8.33',
        description: 'Para profissionais que precisam de mais gravação e IA.',
        minutes: '500',
        minutesNote: 'por mês',
        maxDuration: '30 min',
        retention: '14 días',
        ...
        features: [
            ...
            { name: 'Análise de Sentimento', value: false },
            { name: 'Exportar / Compartilhar', value: 'Usa pool IA' },
            { name: 'Pastas', value: true },
            { name: 'Downloads de Áudio', value: '3/mês' },
        ],
    },
    {
        name: 'Plus',
        ...
        annualPrice: '$149.99',
        annualMonthly: '$12.50',
        description: 'Para usuários avançados com IA superior e exportações ilimitadas.',
        minutes: '1,200',
        minutesNote: 'por mês',
        maxDuration: '60 min',
        retention: '30 días',
        ...
        features: [
            { name: 'Tradução ao Vivo', value: 'Grátis' },
            { name: 'Análise de Sentimento', value: 'Básico' },
            { name: 'Exportar / Compartilhar', value: 'Ilimitado' },
            { name: 'Pastas', value: true },
            { name: 'Downloads de Áudio', value: 'Ilimitado' },
        ],
        highlighted: true,
    },
    {
        ...
        annualPrice: '$199.99',
        annualMonthly: '$16.67',
        description: 'Para equipes com alto volume e insights de sentimento completos.',
        minutes: '1,800',
        minutesNote: 'por mês',
        ...
        features: [
            { name: 'Tradução ao Vivo', value: 'Grátis' },
            { name: 'Análise de Sentimento', value: 'Completo' },
            { name: 'Exportar / Compartilhar', value: 'Ilimitado' },
            { name: 'Pastas', value: true },
            { name: 'Downloads de Áudio', value: 'Ilimitado' },
        ],
    },
    {
        ...
        annualPrice: '$299.99',
        annualMonthly: '$25.00',
        description: 'Capacidade máxima para organizações e equipes grandes.',
        minutes: '2,800',
        minutesNote: 'por mês',
        maxDuration: 'Ilimitado',
        retention: '90 días',
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="flex text-center justify-center items-center gap-4 flex-col mb-16">
                    ...
                    >
                        ...
                        <p className="text-lg leading-relaxed text-gray-600 max-w-2xl text-center">
                            Um pool de IA para todas as funções. Você escolhe como gastar seus usos.
                        </p>
                    </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                    {plans.map((plan, index) => {
                        ...
                        const displayPeriod = plan.annualPrice ? (showAnnual ? '/ mês' : '/ mês') : '';
                                ...
                                >
                                    {plan.highlighted && (
                                        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                                            <Badge className="bg-amber-600 text-white">Mais Popular</Badge>
                                        </div>
                                    )}
                                        ...
                                        <div className="mb-6">
                                            ...
                                            {showAnnual && (
                                                <p className="text-xs text-amber-600 mt-1">
                                                    {plan.annualPrice}/ano — faturado anualmente
                                                </p>
                                            )}
                                        </div>
                                        ...
                                        <div className="space-y-3 mb-6 pb-6 border-b border-gray-100">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">máx por gravação</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">retenção de áudio</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    Os usos de IA são compartilhados entre Resumo, Tarefas, Momentos-chave, AI Chat, Diarização de Falantes e exportações (Starter/Pro). A Tradução ao Vivo é sempre grátis.
                </motion.p>
