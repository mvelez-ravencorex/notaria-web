...
const stages = [
    {
        number: '01',
        title: 'Record',
        description: 'One-tap recording with advanced noise cancellation for crystal clear audio, anywhere.',
        iconColor: 'purple',
    ...
    },
    {
        number: '02',
        title: 'Transcribe',
        description: 'Real-time AI transcription with 99% accuracy and automatic speaker identification.',
        iconColor: 'blue',
    ...
    },
    {
        number: '03',
        title: 'Action',
        description: 'Receive AI summaries, key decisions, and export action items directly to your favorite tools.',
        iconColor: 'green',
        ...
        <section className="relative py-24 px-6 lg:px-20 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a0a1a 0%, #1a0a2e 50%, #0a1a2a 100%)' }}>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        Three simple steps to effortless productivity.
                    </motion.p>
                </div>
