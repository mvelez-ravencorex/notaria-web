...
const stages = [
    {
        number: '01',
        title: 'Graba',
        description: 'Grabación con un toque y cancelación de ruido avanzada para audio cristalino, en cualquier lugar.',
        iconColor: 'purple',
    ...
    },
    {
        number: '02',
        title: 'Transcribe',
        description: 'Transcripción en tiempo real con IA con 99% de precisión e identificación automática de hablantes.',
        iconColor: 'blue',
    ...
    },
    {
        number: '03',
        title: 'Acción',
        description: 'Recibe resúmenes de IA, decisiones clave y exporta tareas directamente a tus herramientas favoritas.',
        iconColor: 'green',
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Tu Camino hacia Reuniones Claras
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        Tres simples pasos para una productividad sin esfuerzo.
                    </motion.p>
                </div>
