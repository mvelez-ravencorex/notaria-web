                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-24">
                        ...
                        <div className="flex-1 text-center lg:text-left z-10">
                            ...
                            >
                                ...
                                Ahora con AI Chat para tus reuniones
                            </motion.div>
                            ...
                            >
                                ...
                                <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-700 to-yellow-600">en segundos</span>
                            </motion.h1>
                            ...
                            >
                                Graba, transcribe y resume tus reuniones con IA. Análisis de sentimiento, tareas, identificación de hablantes y traducción en vivo — todo en iPhone y iPad.
                            </motion.p>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="ml-2">2,000+ usuarios</span>
                                </div>
                        ...
                        <div className="flex-1 relative flex justify-center items-center">
                            ...
                            <FloatingCard className="right-0 -translate-x-0 lg:right-auto lg:left-full lg:-ml-20 top-8 p-3 w-[170px] md:w-[185px] hidden md:block" delay={0.5} rotate={5}>
                                ...
                                <div className="space-y-2">
                                    <div className="bg-gray-100 rounded-lg px-2 py-1.5">
                                        <p className="text-gray-600 text-[10px]">¿Cuáles fueron las tareas?</p>
                                    </div>
                                    <div className="bg-amber-50 rounded-lg px-2 py-1.5">
                                        <p className="text-amber-700 text-[10px]">Se asignaron 3 tareas...</p>
                                    </div>
                                </div>
                            </FloatingCard>
                            ...
                            <FloatingCard className="right-0 -translate-x-0 lg:right-auto lg:left-full lg:-ml-20 top-2/3 p-3 w-[175px] md:w-[190px] hidden md:block" delay={0.7} rotate={-3}>
                                ...
                                <div className="mb-2">
                                    <div className="flex items-center justify-between mb-1">
                                        <span className="text-[10px] text-gray-400">Tono General</span>
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex items-center justify-between">
                                        <span className="text-[10px] text-gray-400">Orador A</span>
                                        <div className="flex items-center gap-1">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span className="text-[10px] text-gray-400">Orador B</span>
                                        <div className="flex items-center gap-1">
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-8 p-3 w-[170px]" delay={0.8} rotate={-6}>
                                <div className="bg-gray-50 rounded-xl p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-xs font-medium text-gray-800">Grabando</span>
                                    </div>
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-1/3 p-3 w-[175px]" delay={0.9} rotate={3}>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-gray-800 text-xs font-medium">Traducción</span>
                                </div>
                                <div className="space-y-2">
                            ...
                            <FloatingCard className="hidden xl:block right-full -mr-20 top-2/3 p-3 w-[195px]" delay={1.0} rotate={4}>
                                ...
                                <p className="text-gray-600 text-[11px] mb-2">
                                    "¡Nos ahorra <span className="bg-amber-100 px-1 rounded text-amber-700">horas cada semana</span>!"
                                </p>
