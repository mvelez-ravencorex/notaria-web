...
const tabs = [
    ...
    { id: 'record', label: 'Record & Transcript', icon: Mic, screen: recordingScreen },
    { id: 'summary', label: 'Summary', icon: Sparkles, screen: summaryScreen },
    { id: 'translation', label: 'Live Translation', icon: Languages, screen: translationScreen },
...
const featureCards: Record<string, Array<{ icon: any; title: string; description: string; position: string }>> = {
    meetings: [
        { icon: Search, title: 'Search', description: 'Find meetings by title', position: 'left' },
        { icon: Clock, title: 'Recent', description: 'Grouped by date', position: 'left' },
        { icon: FolderOpen, title: 'Folders', description: 'Organize your meetings', position: 'left' },
        { icon: Trash2, title: 'Delete', description: 'Swipe left to delete', position: 'right' },
        { icon: Edit3, title: 'Rename', description: 'Swipe to rename', position: 'right' },
        { icon: FolderInput, title: 'Move', description: 'Move to folder', position: 'right' },
    ],
    record: [
        { icon: Mic, title: 'Record Audio', description: 'One-tap microphone button', position: 'left' },
        { icon: FileText, title: 'Live Transcript', description: 'Real-time text while recording', position: 'left' },
        { icon: Globe, title: '6 Languages', description: '🇪🇸 🇺🇸 🇧🇷 🇫🇷 🇩🇪 🇮🇹', position: 'left' },
        { icon: Users, title: 'Speaker Detection', description: 'Identify who is speaking', position: 'right' },
        { icon: Search, title: 'Search & Highlight', description: 'Find keywords in transcript', position: 'right' },
        { icon: Pause, title: 'Pause & Resume', description: 'Without losing audio', position: 'right' },
    ],
    summary: [
        { icon: Brain, title: 'AI Summary', description: 'Key points by Claude AI', position: 'left' },
        { icon: Tags, title: 'Keywords', description: 'Auto-extracted tags', position: 'left' },
        { icon: ListChecks, title: 'Action Items', description: 'Tasks with checkboxes', position: 'left' },
        { icon: Zap, title: 'Key Moments', description: 'Important timestamps', position: 'right' },
        { icon: Languages, title: 'Translate', description: 'Full content translation', position: 'right' },
        { icon: Share2, title: 'Export', description: 'Share or PDF export', position: 'right' },
    ],
    translation: [
        { icon: Globe, title: '5 Languages', description: '🇪🇸 🇺🇸 🇧🇷 🇫🇷 🇩🇪', position: 'left' },
        { icon: Zap, title: 'Real-time', description: 'Translate while recording', position: 'left' },
        { icon: BookOpen, title: 'Split View', description: 'Original + translated', position: 'left' },
        { icon: FileText, title: 'Translate All', description: 'Summary, transcript, tags', position: 'right' },
        { icon: ListChecks, title: 'Action Items', description: 'Tasks in any language', position: 'right' },
        { icon: RefreshCw, title: 'Back to Original', description: 'Remove translation', position: 'right' },
    ],
    sentiment: [
        { icon: SmilePlus, title: 'Overall Mood', description: 'Score 0-100% with emoji & summary', position: 'left' },
        { icon: UserCheck, title: 'Per Speaker', description: 'Color bars: positive, neutral, negative', position: 'left' },
        { icon: Activity, title: 'Dominant Mood', description: 'Enthusiastic, concerned, frustrated...', position: 'left' },
        { icon: TrendingUp, title: 'Timeline', description: 'Sentiment evolution over time', position: 'right' },
        { icon: AlertTriangle, title: 'Tension Moments', description: 'Conflicts with severity & resolution', position: 'right' },
        { icon: Lightbulb, title: 'AI Insights', description: 'Actionable observations by Claude AI', position: 'right' },
    ],
    chat: [
        { icon: MessageSquare, title: 'Ask Questions', description: 'About your meeting', position: 'left' },
        { icon: Sparkles, title: 'Suggested Questions', description: 'AI-generated prompts', position: 'left' },
        { icon: FileText, title: 'Full Context', description: 'Transcript + speakers', position: 'left' },
        { icon: BookOpen, title: 'Chat History', description: 'User/AI message bubbles', position: 'right' },
        { icon: CheckCircle, title: 'Copy Responses', description: 'Select and copy text', position: 'right' },
        { icon: Brain, title: 'Claude AI', description: 'Smart, contextual answers', position: 'right' },
    ],
};
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        See it <span className="bg-gradient-to-r from-amber-700 via-yellow-500 to-amber-600 bg-clip-text text-transparent">in action</span>
                    </motion.h2>
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        From recording to AI insights, everything happens seamlessly
                    </motion.p>
                </div>
