                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="rounded-3xl p-8 border border-white/10 shadow-2xl" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(32px)', WebkitBackdropFilter: 'blur(32px)' }}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-2xl border border-white/10" style={{ background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
                                    <div className="text-xs text-white/60 mb-3 uppercase tracking-wider font-medium">Audio Input</div>
                                ...
                                <div className="flex items-center justify-center py-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-medium text-amber-300">AI Processing...</span>
                                    </motion.div>
                                </div>
                                ...
                                <div className="p-4 bg-emerald-500/10 backdrop-blur-md rounded-2xl border border-emerald-500/20">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="text-xs text-emerald-400 uppercase tracking-wider font-medium">Summary Ready</span>
                                    </div>
                                    <p className="text-white/80 text-sm leading-relaxed">
                                        The team agreed to prioritize the mobile release for Q4. Key action items include finalizing API docs and scheduling user testing.
                                    </p>
                                </div>
                    ...
                    <motion.div className="order-1 lg:order-2" style={{ transform: `translateY(${-rightCardY}px)` }}>
                        ...
                        >
                            ...
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">True understanding</span>
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            viewport={{ once: true }}
                        >
                            Our AI doesn't just convert speech to text. It understands context, identifies speakers, extracts action items, and generates summaries that capture what actually matters.
                        </motion.p>

                        {/* Features List */}
                        <div className="space-y-5">
                            {[
                                { icon: Zap, title: 'Real-time processing', description: 'See transcription as it happens' },
                                { icon: Globe, title: '6 languages supported', description: 'English, Spanish, Portuguese, French, German, Italian' },
                                { icon: Shield, title: 'On-device translation', description: 'Translation is 100% local via Apple Framework — free on all plans' }
                            ].map((feature, i) => (
                                <motion.div
                                    key={i}
