...
export function FeaturesAccordionIt() {
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-700 via-yellow-500 to-amber-600">
                riunioni più intelligenti
              </span>
            </h2>
            <p className="mt-6 text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
              Dalla registrazione alle analisi basate sull'IA — NotarIA si occupa di ogni aspetto delle tue riunioni, così puoi concentrarti su ciò che conta.
            </p>
