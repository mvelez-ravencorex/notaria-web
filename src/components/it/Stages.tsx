...
const stages = [
    {
        number: '01',
        title: 'Registra',
        description: 'Registrazione con un tocco e riduzione avanzata del rumore per un suono cristallino, ovunque.',
        iconColor: 'purple',
    ...
    },
    {
        number: '02',
        title: 'Trascrivi',
        description: 'Trascrizione IA in tempo reale con il 99% di accuratezza e riconoscimento automatico dei relatori.',
        iconColor: 'blue',
    ...
    },
    {
        number: '03',
        title: 'Agisci',
        description: 'Ottieni riassunti IA, decisioni chiave ed esporta le attività direttamente nei tuoi strumenti preferiti.',
        iconColor: 'green',
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Il tuo percorso verso riunioni chiare
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        Tre semplici passaggi per una produttività senza sforzo.
                    </motion.p>
                </div>
